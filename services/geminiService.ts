...
if (!API_KEY || API_KEY === 'PLACEHOLDER_API_KEY') {
  console.warn('Gemini API key not set. Please set GEMINI_API_KEY in .env.local');
}

const genai = new GoogleGenAI({ apiKey: API_KEY });

// Weather API helper (using OpenWeatherMap)
const WEATHER_API_KEY = ''; // OpenWeatherMap API key would go here in production
